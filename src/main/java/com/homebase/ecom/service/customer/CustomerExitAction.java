...
@Service
public class CustomerExitAction implements STMTransitionAction<Customer> {
    ...
    public void doTransition(Customer customer, Object transitionParam, State startState, String eventId, State endState, STMInternalTransitionInvoker<?> stm, Transition transition) throws Exception {
        // Exit action for customer flow
        // Clean up resources
        // Log exit
        System.out.println("Exiting customer flow for: " + customer.getEmail());
    }
}
