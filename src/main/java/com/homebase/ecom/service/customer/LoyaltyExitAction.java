...
@Service
public class LoyaltyExitAction implements STMTransitionAction<Customer> {
    ...
    public void doTransition(Customer customer, Object transitionParam, State startState, String eventId, State endState, STMInternalTransitionInvoker<?> stm, Transition transition) throws Exception {
        // Exit action for loyalty flow
        // Finalize tier assignment
        System.out.println("Loyalty tier assigned for customer: " + customer.getEmail());
    }
}
