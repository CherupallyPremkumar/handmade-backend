...
@Service
public class UnbanCustomerAction implements STMTransitionAction<Customer> {
    ...
    public void doTransition(Customer customer, Object transitionParam, State startState, String eventId, State endState, STMInternalTransitionInvoker<?> stm, Transition transition) throws Exception {
        // Unban customer (exceptional case)
        // Restore to suspended state for review
        // Log unban reason
        System.out.println("Customer unbanned: " + customer.getEmail());
    }
}
