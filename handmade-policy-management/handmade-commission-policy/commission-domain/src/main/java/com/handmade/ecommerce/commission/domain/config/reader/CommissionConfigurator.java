package com.handmade.ecommerce.commission.domain.config.reader;

import com.fasterxml.jackson.databind.ObjectMapper;
import com.fasterxml.jackson.datatype.jsr310.JavaTimeModule;
import com.handmade.ecommerce.commission.domain.config.model.CommissionConfig;
...
public class CommissionConfigurator {
    ...
    private static final String CONFIG_FILE = "com/handmade/ecommerce/commission/domain/commission-config.json";
