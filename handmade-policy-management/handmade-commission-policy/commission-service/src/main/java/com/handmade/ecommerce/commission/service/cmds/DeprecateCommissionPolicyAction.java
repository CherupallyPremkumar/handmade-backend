...
/**
 * Action to deprecate an active commission policy
 */
public class DeprecateCommissionPolicyAction extends AbstractSTMTransitionAction<CommissionPolicy, Object> {
    @Override
    public void transitionTo(CommissionPolicy policy, Object payload, State startState, 
        ...
        // Handle deprecation logic if needed
    }
}
