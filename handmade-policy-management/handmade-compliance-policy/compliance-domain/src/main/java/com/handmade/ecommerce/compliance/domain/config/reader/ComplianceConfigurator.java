...
import com.handmade.ecommerce.compliance.domain.config.model.ComplianceConfig;
...
public class ComplianceConfigurator {
    ...
    private static final String CONFIG_FILE = "com/handmade/ecommerce/compliance/domain/compliance-rules.json";
