...
public class AddPerformanceThresholdPayload implements Serializable {
    private static final long serialVersionUID = 1L;
    
    private String ruleName; // Using ruleName as identifier for consistency if needed, but PerformanceThreshold uses violationType
