package com.handmade.ecommerce.user.configuration.controller;
...
@RestController
@ChenileController(value = "userService", serviceName = "_userStateEntityService_",
		healthCheckerName = "userHealthChecker")
