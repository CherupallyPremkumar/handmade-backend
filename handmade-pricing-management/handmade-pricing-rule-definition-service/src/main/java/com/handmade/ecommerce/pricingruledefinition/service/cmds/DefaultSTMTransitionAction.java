...
public class DefaultSTMTransitionAction<PayloadType extends MinimalPayload>
    extends AbstractSTMTransitionAction<PricingRuleDefinition, PayloadType> {
    @Override
    public void transitionTo(PricingRuleDefinition pricingruledefinition, PayloadType payload,
