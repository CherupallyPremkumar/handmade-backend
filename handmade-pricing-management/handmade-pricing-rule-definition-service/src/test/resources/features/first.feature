Feature: Tests the pricingruledefinition Workflow Service using a REST client. This is done only for the
first testcase. Pricingruledefinition service exists and is under test.
...
And the REST response key "mutatedEntity.ruleKey" is "RULE-001"
...
Scenario: Send an invalid event to pricingruledefinition . This will err out.
When I PATCH a REST request to URL "/pricingruledefinition/${id}/invalid" with payload
"""json
{
