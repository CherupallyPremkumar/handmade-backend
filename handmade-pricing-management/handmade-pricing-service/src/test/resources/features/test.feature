Feature: Testcase ID 
Tests the pricing Workflow Service using a REST client. Pricing service exists and is under test.
...
Scenario: Send the pause event to the pricing with comments
