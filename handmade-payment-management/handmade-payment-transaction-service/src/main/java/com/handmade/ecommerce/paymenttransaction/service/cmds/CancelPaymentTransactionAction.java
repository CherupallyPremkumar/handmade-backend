...
import com.handmade.ecommerce.payment.model. CancelPaymentTransactionPayload;
...
*/
public class CancelPaymentTransactionAction extends AbstractSTMTransitionAction<PaymentTransaction,
    CancelPaymentTransactionPayload>{

	@Override
	public void transitionTo(PaymentTransaction paymenttransaction,
            CancelPaymentTransactionPayload payload,
