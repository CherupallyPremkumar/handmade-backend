...
public class DefaultSTMTransitionAction<PayloadType extends MinimalPayload>
    extends AbstractSTMTransitionAction<PaymentAuthorization, PayloadType> {
    @Override
    public void transitionTo(PaymentAuthorization paymentauthorization, PayloadType payload,
