...
/**
 * Resolves onboarding policy from Policy Service
...
public class ResolvePolicyCommand implements Command<Map<String, Object>> {
    ...
    public ResolvePolicyCommand(PolicyManagerClient policyManagerClient) {
    ...
    public void execute(Map<String, Object> context) throws Exception {
        ...
        SellerType sellerType = SellerType.valueOf(sellerTypeStr);
        
        // Call Policy Service to resolve policy
        OnboardingPolicy policy = policyManagerClient.resolveOnboardingPolicy(countryCode, sellerType);
        
        // Store in context
        context.put("onboardingPolicy", policy);
        context.put("policyId", policy.getId());
        context.put("policyVersion", policy.getVersion());
