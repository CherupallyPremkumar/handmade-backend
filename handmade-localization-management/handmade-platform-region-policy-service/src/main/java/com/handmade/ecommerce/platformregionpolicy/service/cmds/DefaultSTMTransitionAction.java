...
public class DefaultSTMTransitionAction<PayloadType extends MinimalPayload>
    extends AbstractSTMTransitionAction<PlatformRegionPolicy, PayloadType> {
    @Override
    public void transitionTo(PlatformRegionPolicy platformregionpolicy, PayloadType payload,
