...
import com.handmade.ecommerce.cart.service.cmds.*;
...
public class CartConfiguration {
	...
	@Bean STMFlowStoreImpl cartFlowStore(
            @Qualifier("cartBeanFactoryAdapter") BeanFactoryAdapter cartBeanFactoryAdapter
            )throws Exception{
	...
	@Bean GenericExitAction<Cart> cartExitAction(@Qualifier("cartFlowStore") STMFlowStoreImpl stmFlowStore){
    ...
    @Bean MergeCartAction
            cartMerge(){
        return new MergeCartAction();
    }

    @Bean CheckoutCartAction
            cartCheckout(){
        return new CheckoutCartAction();
    }
    @Bean RecoverCartAction
            cartRecover(){
        return new RecoverCartAction();
    }
    @Bean ExpireCartAction
            cartExpire(){
        return new ExpireCartAction();
    }
    @Bean AbandonCartAction
            cartAbandon(){
        return new AbandonCartAction();
    }
    @Bean ConvertCartAction
            cartConvert(){
        return new ConvertCartAction();
    }
