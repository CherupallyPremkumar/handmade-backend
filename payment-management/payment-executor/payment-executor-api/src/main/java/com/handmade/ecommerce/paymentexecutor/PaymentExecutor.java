...
import com.handmade.ecommerce.paymentexecutor.model.*;
 ...
 * 
 * Strategy interface for executing payment operations with different PSPs (Payment Service Providers).
 * Implementations include RazorpayExecutor, StripeExecutor, PayPalExecutor, etc.
 * 
 * This interface abstracts PSP-specific logic and allows the orchestrator to work with
