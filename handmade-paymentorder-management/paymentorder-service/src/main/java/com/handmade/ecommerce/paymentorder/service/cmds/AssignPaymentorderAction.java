...
import com.handmade.ecommerce.paymentorder.dto.AssignPaymentorderPayload;
...
*/
public class AssignPaymentorderAction extends AbstractSTMTransitionAction<Paymentorder,

    AssignPaymentorderPayload>{


	@Override
	public void transitionTo(Paymentorder paymentorder,
            AssignPaymentorderPayload payload,
