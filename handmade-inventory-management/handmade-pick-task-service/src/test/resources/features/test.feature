Feature: Testcase ID 
Tests the picktask Workflow Service using a REST client. Picktask service exists and is under test.
...
Scenario: Send the complete event to the picktask with comments
