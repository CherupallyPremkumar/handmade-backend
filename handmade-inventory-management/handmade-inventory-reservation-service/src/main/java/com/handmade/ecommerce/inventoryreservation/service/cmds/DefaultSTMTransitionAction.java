...
public class DefaultSTMTransitionAction<PayloadType extends MinimalPayload>
    extends AbstractSTMTransitionAction<InventoryReservation, PayloadType> {
    @Override
    public void transitionTo(InventoryReservation inventoryreservation, PayloadType payload,
