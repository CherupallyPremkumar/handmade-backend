...
public class DefaultSTMTransitionAction<PayloadType extends MinimalPayload>
    extends AbstractSTMTransitionAction<InboundShipmentItem, PayloadType> {
    @Override
    public void transitionTo(InboundShipmentItem inboundshipmentitem, PayloadType payload,
