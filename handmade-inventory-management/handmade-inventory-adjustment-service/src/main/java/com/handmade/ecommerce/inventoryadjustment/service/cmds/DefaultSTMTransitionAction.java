...
public class DefaultSTMTransitionAction<PayloadType extends MinimalPayload>
    extends AbstractSTMTransitionAction<InventoryAdjustment, PayloadType> {
    @Override
    public void transitionTo(InventoryAdjustment inventoryadjustment, PayloadType payload,
