package com.handmade.ecommerce.settlement.configuration.controller;
...
@RestController
@ChenileController(value = "settlementService", serviceName = "_settlementStateEntityService_",
		healthCheckerName = "settlementHealthChecker")
