package com.handmade.ecommerce.supplier.configuration.controller;
...
@RestController
@ChenileController(value = "supplierService", serviceName = "_supplierStateEntityService_",
		healthCheckerName = "supplierHealthChecker")
