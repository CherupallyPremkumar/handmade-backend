...
public class CreateSellerAccountRequest implements Serializable {
    ...
    public CreateSellerAccountRequest() {
    }

    public CreateSellerAccountRequest(String email, String country, String sellerType, String policyId,
