...
import com.handmade.ecommerce.seller.account.dto.BankUpdateRequest;
import com.handmade.ecommerce.seller.account.dto.IdentityUpdateRequest;
import com.handmade.ecommerce.identity.dto.IdentityVerificationView;
import com.handmade.ecommerce.seller.account.dto.TaxUpdateRequest;
...
public class OnboardingSellerController extends ControllerSupport {
    ...
    public ResponseEntity<GenericResponse<StateEntityServiceResponse<SellerAccount>>> create(
            HttpServletRequest httpServletRequest,
            @ChenileParamType(StateEntity.class) @RequestBody SellerAccount entity) {
