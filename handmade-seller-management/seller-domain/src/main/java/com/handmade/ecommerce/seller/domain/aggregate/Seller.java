...
// import com.handmade.ecommerce.location.model.Location;  // TODO: Add location-management dependency
...
/**
 * Seller Aggregate - Manages seller storefront operations
 * 
 * Part of dual-aggregate pattern:
 * - SellerAccount = Account lifecycle, KYC, metrics
 * - Seller = Store operations, branding, tax compliance
 * 
 * One SellerAccount can have multiple Seller stores
 */
@Entity
@Table(name = "seller_store")  // Renamed from hm_seller
public class Seller extends AbstractJpaStateEntity
    implements ActivityEnabledStateEntity, ContainsTransientMap
{

    // Link to SellerAccount aggregate
    @Column(name = "seller_account_id", nullable = false, length = 36)
    private String sellerAccountId;  // FK to SellerAccount
