...
public class DefaultSTMTransitionAction<PayloadType extends MinimalPayload>
    extends AbstractSTMTransitionAction<SellerOnboardingStep, PayloadType> {
    @Override
    public void transitionTo(SellerOnboardingStep selleronboardingstep, PayloadType payload,
