...
import com.handmade.ecommerce.identity.dto.VerificationSessionResponse;
import com.handmade.ecommerce.identity.infrastructure.repository.IdentityVerificationRepository;
import com.handmade.ecommerce.identity.infrastructure.stripe.StripeIdentityClient;
...
class IdentityVerificationServiceTest {
    ...
    @Mock
    private StripeIdentityClient stripeClient;
    ...
    void submitIdentityDocuments_WithStripeConfigured_CreatesStripeSession() {
        ...
        when(stripeClient.createVerificationSession(any()))
                .thenReturn(response);
        ...
        verify(stripeClient, times(1)).createVerificationSession(any());
    }
