 ...
 */
public class LockPolicyAction extends AbstractSTMTransitionAction<SellerOnboardingCase, LockPolicyRequest> {

    @Override
    public void transitionTo(SellerOnboardingCase sellerCase, LockPolicyRequest payload, State startState, String eventId,
