 ...
 * expressions.
 * Example Rule: "price < 50 and active == true"
 */
@Component
public class DynamicRuleEvaluator {
    ...
    public boolean matches(String ruleExpression, ExternalProductDto product) {
        ...
        try {
            ...
            log.warn("Invalid rule evaluation for product {}: Rule='{}' Error={}", product.getId(), ruleExpression,
                    e.getMessage());
            return false;
        }
    }
