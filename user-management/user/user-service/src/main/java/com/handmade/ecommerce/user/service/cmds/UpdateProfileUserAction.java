...
import com.handmade.ecommerce.user.dto.UpdateProfileUserPayload;
...
*/
public class UpdateProfileUserAction extends AbstractSTMTransitionAction<User,
	...
	public void transitionTo(User user,
            UpdateProfileUserPayload payload,
