...
public class CustomerProfileController extends ControllerSupport{
	
    @PostMapping("/customer")
    public ResponseEntity<GenericResponse<CustomerProfile>> save(
        HttpServletRequest httpServletRequest,
        @RequestBody CustomerProfile entity){
        return process(httpServletRequest,entity);
        }

    @GetMapping("/customer/{id}")
    public ResponseEntity<GenericResponse<CustomerProfile>> retrieve(
    HttpServletRequest httpServletRequest,
