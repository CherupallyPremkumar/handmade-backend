...
import com.handmade.ecommerce.customer.dto.ExpireSubscriptionPayload;
...
*/
public class ExpireSubscriptionAction extends AbstractSTMTransitionAction<Subscription,
    ExpireSubscriptionPayload>{

	@Override
	public void transitionTo(Subscription subscription,
            ExpireSubscriptionPayload payload,
