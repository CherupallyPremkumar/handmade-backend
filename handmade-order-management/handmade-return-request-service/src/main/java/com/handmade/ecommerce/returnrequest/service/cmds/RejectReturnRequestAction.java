...
import com.handmade.ecommerce.order.model. RejectReturnRequestPayload;
...
*/
public class RejectReturnRequestAction extends AbstractSTMTransitionAction<ReturnRequest,
    RejectReturnRequestPayload>{

	@Override
	public void transitionTo(ReturnRequest returnrequest,
            RejectReturnRequestPayload payload,
