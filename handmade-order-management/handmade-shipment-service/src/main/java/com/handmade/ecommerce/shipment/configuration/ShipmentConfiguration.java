...
public class ShipmentConfiguration {
	...
	@Bean STM<Shipment> shipmentEntityStm(@Qualifier("shipmentFlowStore") STMFlowStoreImpl stmFlowStore) throws Exception{
		STMImpl<Shipment> stm = new STMImpl<>();		
		stm.setStmFlowStore(stmFlowStore);
		return stm;
	}
	
	@Bean STMActionsInfoProvider shipmentActionsInfoProvider(@Qualifier("shipmentFlowStore") STMFlowStoreImpl stmFlowStore) {
	...
	@Bean StateEntityServiceImpl<Shipment> _shipmentStateEntityService_(
	...
	@Bean GenericEntryAction<Shipment> shipmentEntryAction(@Qualifier("shipmentEntityStore") EntityStore<Shipment> entityStore,
			@Qualifier("shipmentActionsInfoProvider") STMActionsInfoProvider shipmentInfoProvider,
    ...
    @Bean StmBodyTypeSelector shipmentBodyTypeSelector(
    @Qualifier("shipmentActionsInfoProvider") STMActionsInfoProvider shipmentInfoProvider,
    ...
    @Bean STMTransitionAction<Shipment> shipmentBaseTransitionAction(
        @Qualifier("shipmentTransitionActionResolver") STMTransitionActionResolver stmTransitionActionResolver){
