...
public class OrderConfiguration {
    ...
    @Bean
    EntityStore<Order> orderEntityStore() {
    ...
    @Bean
    AddOrderAction orderAddAction() {
        return new AddOrderAction();
    }

    @Bean
    NoOrderAction orderNoAction() {
        return new NoOrderAction();
    }

    @Bean
    OrderPlacedOrderAction orderOrderPlacedAction() {
        return new OrderPlacedOrderAction();
    }

    @Bean
    FulfillOrderAction orderFulfillAction() {
        return new FulfillOrderAction();
    }

    @Bean
    YesOrderAction orderYesAction() {
    ...
    @Bean
    @Autowired
    Function<ChenileExchange, String[]> orderEventAuthoritiesSupplier(
            @Qualifier("orderActionsInfoProvider") STMActionsInfoProvider orderInfoProvider)
            throws Exception {
    ...
    @Bean
    AVAILABLEOrderPostSaveHook orderAVAILABLEPostSaveHook() {
        return new AVAILABLEOrderPostSaveHook();
    }

    @Bean
    BACKORDEROrderPostSaveHook orderBACKORDERPostSaveHook() {
