...
domains = [
    "iam", "notification", "cms", "seo", "analytics", "adtech", "experiment",
    "governance", "risk", "policy", "localization", "messaging", "event",
    "integration", "limit", "observability", "platform", "onboarding", "comparison"
]

# Note: handmade-search-management already exists
