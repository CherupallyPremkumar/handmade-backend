Feature: Testcase ID 
Tests the financialtransaction Workflow Service using a REST client. Financialtransaction service exists and is under test.
...
Scenario: Send the complete event to the financialtransaction with comments
