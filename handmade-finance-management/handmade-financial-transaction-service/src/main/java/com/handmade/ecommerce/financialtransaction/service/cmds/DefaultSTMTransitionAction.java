...
public class DefaultSTMTransitionAction<PayloadType extends MinimalPayload>
    extends AbstractSTMTransitionAction<FinancialTransaction, PayloadType> {
    @Override
    public void transitionTo(FinancialTransaction financialtransaction, PayloadType payload,
