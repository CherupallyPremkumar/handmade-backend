Feature: Tests the financeprofile Workflow Service using a REST client. This is done only for the
first testcase. Financeprofile service exists and is under test.
...
And the REST response key "mutatedEntity.sellerId" is "seller-first-001"
...
Scenario: Send the reject event to the financeprofile with comments
...
Scenario: Send an invalid event to financeprofile. This will err out.
When I PATCH a REST request to URL "/financeprofile/${id}/invalid" with payload
"""json
{
