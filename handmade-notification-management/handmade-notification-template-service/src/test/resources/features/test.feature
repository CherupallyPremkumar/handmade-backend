Feature: Testcase ID 
Tests the notificationtemplate Workflow Service using a REST client. Notificationtemplate service exists and is under test.
...
And store "$.payload.mutatedEntity.currentState.stateId" from response to "finalState"
Scenario: Send the deactivate event to the notificationtemplate with comments
