package com.handmade.ecommerce.notification.configuration.controller;
...
@RestController
@ChenileController(value = "notificationService", serviceName = "_notificationStateEntityService_",
		healthCheckerName = "notificationHealthChecker")
