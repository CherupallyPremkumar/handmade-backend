...
import java.util.*;
import com.handmade.ecommerce.artisan.model.ArtisanActivityLog;
    ...
    ContainsTransientMap
{
    ...
    public List< ArtisanActivityLog> activities = new ArrayList<>();
    ...
    public ActivityLog addActivity(String eventId, String comment) {
        ArtisanActivityLog activityLog = new ArtisanActivityLog();
