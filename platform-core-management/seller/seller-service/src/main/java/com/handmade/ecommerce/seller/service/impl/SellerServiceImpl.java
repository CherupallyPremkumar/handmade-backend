...
public class SellerServiceImpl extends StateEntityServiceImpl<Seller> {
    public SellerServiceImpl(STM<Seller> stm, STMActionsInfoProvider stmActionsInfoProvider, EntityStore<Seller> entityStore) {
    ...
    public StateEntityServiceResponse<Seller> processById(String id, String event, Object payload) {
        if (payload == null) {
            throw new ServerException(ErrorCodes.SELLER_REQUEST_PAYLOAD_IS_NULL.getSubError(), new Object[]{payload});
        }
