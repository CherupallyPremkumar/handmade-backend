...
import com.handmade.ecommerce.shipping.service.cmds.*;
...
import com.handmade.ecommerce.shipping.service.postSaveHooks.*;
...
public class ShippingConfiguration {
	private static final String FLOW_DEFINITION_FILE = "com/handmade/ecommerce/shipping/shipping-states.xml";
    ...
    @Bean @Autowired DefaultPostSaveHook<Shipping> shippingDefaultPostSaveHook(
    ...
    @Bean @Autowired DefaultAutomaticStateComputation<Shipping> shippingDefaultAutoState(
    @Qualifier("shippingTransitionActionResolver") STMTransitionActionResolver stmTransitionActionResolver,
    @Qualifier("shippingFlowStore") STMFlowStoreImpl stmFlowStore){
    ...
    @Bean SuspendShippingAction
            shippingSuspendAction(){
        return new SuspendShippingAction();
    }

    @Bean ActivateShippingAction
            shippingActivateAction(){
        return new ActivateShippingAction();
    }

    @Bean DeactivateShippingAction
            shippingDeactivateAction(){
        return new DeactivateShippingAction();
    }
    ...
    @Bean CREATEDShippingPostSaveHook
        shippingCREATEDPostSaveHook(){
            return new CREATEDShippingPostSaveHook();
    }

    @Bean ACTIVEShippingPostSaveHook
        shippingACTIVEPostSaveHook(){
            return new ACTIVEShippingPostSaveHook();
    }

    @Bean INACTIVEShippingPostSaveHook
        shippingINACTIVEPostSaveHook(){
            return new INACTIVEShippingPostSaveHook();
    }

    @Bean SUSPENDEDShippingPostSaveHook
        shippingSUSPENDEDPostSaveHook(){
            return new SUSPENDEDShippingPostSaveHook();
    }
