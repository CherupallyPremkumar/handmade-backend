...
"""json
{
    "jobName": "DailySalesInventorySync",
...
"""
    ...
    And the REST response key "mutatedEntity.jobName" is "DailySalesInventorySync"
  ...
  Scenario: Send the cancel event to the etljob with comments
    Given that "comment" equals "Cancelled due to high server load"
